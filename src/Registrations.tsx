      ...
      <header className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            {showSearchButtons && (
              <>
                <button className="bg-white px-4 py-2 rounded-lg text-purple-700 hover:bg-purple-100 hover:shadow-lg transition-all flex items-center gap-2">
                ...
                data.map((item) => (
                  <tr key={item.key} className="border-t hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3 flex gap-2">
                      <button
                        onClick={() => handleViewMore(item.key)} // Add onClick handler
