...
import { Search, CloudDownload, Check, X, Trash2, Sun, AlertTriangle, Lock, BriefcaseMedical } from "lucide-react";
...
const getDuration = (start, end) => {
  ...
  return Math.abs(Math.ceil((endDate - startDate) / (1000 * 60 * 60 * 24))) + " days";
};
...
const getLeaveTypeIcon = (type) => {
  switch ((type || "").toLowerCase()) {
    case "sick":
      return (
        <>
          <BriefcaseMedical size={18} className="inline-block mr-1 text-[#e11d48]" title="Sick" />
    ...
    case "vacation":
      return (
        <>
          <Sun size={18} className="inline-block mr-1 text-[#facc15]" title="Vacation" />
    ...
    case "personal":
      return (
        <>
          <Lock size={18} className="inline-block mr-1 text-[#3b82f6]" title="Personal" />
    ...
    case "emergency":
      return (
        <>
          <AlertTriangle size={18} className="inline-block mr-1 text-[#ef4444]" title="Emergency" />
    ...
    default:
      return (
        <>
          <Sun size={18} className="inline-block mr-1 text-[#22c55e]" title="Other" />
          <span className="text-[#22c55e] font-semibold">{type || "Other"}</span>
        </>
      );
  }
};
