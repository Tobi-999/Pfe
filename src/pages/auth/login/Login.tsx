    ...
    <div className="flex flex-1 items-center justify-center w-screen min-h-screen">
      ...
      <div className="flex flex-1 flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
        <div className="w-full max-w-md">
          <h1 className="text-5xl md:text-7xl font-extrabold text-center mb-10 bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent drop-shadow-2xl transition-all duration-500  hover:from-pink-500 hover:to-blue-400 cursor-pointer animate-pulse">
            Log in
          </h1>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    <>
                      ...
                      >
                        <path
                          ...
                          d="M13.875 18.825A10.05 10.05 0 0112 19c-5.523 0-10-4.477-10-10 0-1.657.336-3.233.938-4.675M6.343 6.343A7.963 7.963 0 004 9c0 4.418 3.582 8 8 8 1.657 0 3.233-.336 4.675-.938M17.657 17.657A7.963 7.963 0 0020 15c0-4.418-3.582-8-8-8-1.657 0-3.233.336-4.675.938M3 3l18 18"
                        />
                      </svg>
                      Hide
                    </>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center cursor-pointer select-none">
                <input
                  type="checkbox"
                  className="mr-2 accent-purple-500 scale-125 transition-all duration-300"
                />
                <span className="text-sm font-medium text-gray-700 hover:text-blue-500 transition-colors duration-300">
      ...
      <div className="flex-1 relative min-h-screen">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-4">
          <h1 className="text-5xl md:text-6xl font-extrabold text-center leading-tight mb-4 group">
            <span
              className="block bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent drop-shadow-lg transition-all duration-500
                 group-hover:animate-none group-hover:scale-110 group-hover:-translate-y-2 group-hover:from-pink-500 group-hover:to-blue-400"
            >
